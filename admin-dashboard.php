...
<head>
    ...
    <style>
        body { 
            ...
            color: white; font-family: 'Segoe UI', sans-serif; margin: 0; padding: 40px; min-height: 100vh;
        }
        .dashboard-card {
        ...
        .priority-badge { font-size: 0.75rem; font-weight: bold; padding: 4px 8px; border-radius: 4px; }
        .p-Urgent { background: rgba(248, 113, 113, 0.2); color: #f87171; }
        .p-Priority { background: rgba(93, 173, 226, 0.2); color: #5dade2; }
        .p-General { color: #94a3b8; }
...
<div class="dashboard-card">
    <div class="header">
        <div>
            ...
            <p style="color: rgba(255,255,255,0.5);">CITE005 Info Management Project</p>
        </div>
    ...
    <form method="GET" class="search-container">
        ...
        <button type="submit" class="btn-resolve">Filter Data</button>
        <?php if($search): ?> <a href="admin-dashboard.php" style="color: grey; padding: 10px; text-decoration:none;">Clear</a> <?php endif; ?>
    </form>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="<?php echo $isResolved ? 'resolved-row' : ''; ?>">
                ...
                <td>
                    <span class="priority-badge p-<?php echo $pLevel; ?>">
                        <?php echo $pLevel; ?>
                    </span>
                </td>
                <td>
